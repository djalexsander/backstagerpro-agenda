          ...
          <Card>
            <CardContent className="space-y-4 p-4">
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="space-y-1"><Label>De</Label><DatePicker value={historyFilters.dateFrom} onChange={(value) => updateFilter("dateFrom", value)} clearable placeholder="De" /></div>
                <div className="space-y-1"><Label>Até</Label><DatePicker value={historyFilters.dateTo} onChange={(value) => updateFilter("dateTo", value)} clearable placeholder="Até" /></div>
              </div>
