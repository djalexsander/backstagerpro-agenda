...
import { Plus, Pencil, Trash2, FileDown, X, Users, CheckCircle2, Clock, ImageIcon } from "lucide-react";
...
// Financeiro de Eventos: cachês, custos por evento e lucro/prejuízo por
// evento. Extraído da antiga página Financeiro monolítica para viver como a
// aba "Eventos" - mesma lógica/queries/mutations de antes, sem alteração de
// comportamento. financials usa a mesma queryKey (["financials", empresaId])
// que a aba Geral e o diálogo de exportação em Financeiro.tsx já consultam,
// então o cache do react-query é compartilhado entre os três - não há
// requisição duplicada nem uma segunda fonte de dados.
export function EventosFinanceiroPanel({
  empresaId,
  empresaReadOnly,
  canExport,
  empresaNome,
